...
곤산수입검사_불량수량_2024년 =  100
곤산공정검사_불량수량_2024년 =  60
곤산출하검사_불량수량_2024년 =  50
곤산고객사라인불만건수_2024년 = 40
곤산필드클레임목표금액_2024년 = 90_000_000
곤산Q_Cost_2024년 =            9_000_000
...
곤산인라인부적합수량_1월 = 고객사라인부적합현황.query("일자.str.contains('2024.01.')")
곤산인라인부적합수량_1월 = int(곤산인라인부적합수량_1월['수량'].sum())
곤산인라인부적합수량_2월 = 고객사라인부적합현황.query("일자.str.contains('2024.02.')")
곤산인라인부적합수량_2월 = int(곤산인라인부적합수량_2월['수량'].sum())
곤산인라인부적합수량_3월 = 고객사라인부적합현황.query("일자.str.contains('2024.03.')")
곤산인라인부적합수량_3월 = int(곤산인라인부적합수량_3월['수량'].sum())
곤산인라인부적합수량_4월 = 고객사라인부적합현황.query("일자.str.contains('2024.04.')")
곤산인라인부적합수량_4월 = int(곤산인라인부적합수량_4월['수량'].sum())
곤산인라인부적합수량_5월 = 고객사라인부적합현황.query("일자.str.contains('2024.05.')")
곤산인라인부적합수량_5월 = int(곤산인라인부적합수량_5월['수량'].sum())
곤산인라인부적합수량_6월 = 고객사라인부적합현황.query("일자.str.contains('2024.06.')")
곤산인라인부적합수량_6월 = int(곤산인라인부적합수량_6월['수량'].sum())
곤산인라인부적합수량_7월 = 고객사라인부적합현황.query("일자.str.contains('2024.07.')")
곤산인라인부적합수량_7월 = int(곤산인라인부적합수량_7월['수량'].sum())
곤산인라인부적합수량_8월 = 고객사라인부적합현황.query("일자.str.contains('2024.08.')")
곤산인라인부적합수량_8월 = int(곤산인라인부적합수량_8월['수량'].sum())
곤산인라인부적합수량_9월 = 고객사라인부적합현황.query("일자.str.contains('2024.09.')")
곤산인라인부적합수량_9월 = int(곤산인라인부적합수량_9월['수량'].sum())
곤산인라인부적합수량_10월 = 고객사라인부적합현황.query("일자.str.contains('2024.10.')")
곤산인라인부적합수량_10월 = int(곤산인라인부적합수량_10월['수량'].sum())
곤산인라인부적합수량_11월 = 고객사라인부적합현황.query("일자.str.contains('2024.11.')")
곤산인라인부적합수량_11월 = int(곤산인라인부적합수량_11월['수량'].sum())
곤산인라인부적합수량_12월 = 고객사라인부적합현황.query("일자.str.contains('2024.12.')")
...
곤산필드클레임_1월 = 필드클레임현황.query("일자.str.contains('2024.01.')")
곤산필드클레임_1월 = int(len(곤산필드클레임_1월['수량']))
곤산필드클레임_2월 = 필드클레임현황.query("일자.str.contains('2024.02.')")
곤산필드클레임_2월 = int(len(곤산필드클레임_2월['수량']))
곤산필드클레임_3월 = 필드클레임현황.query("일자.str.contains('2024.03.')")
곤산필드클레임_3월 = int(len(곤산필드클레임_3월['수량']))
곤산필드클레임_4월 = 필드클레임현황.query("일자.str.contains('2024.04.')")
곤산필드클레임_4월 = int(len(곤산필드클레임_4월['수량']))
곤산필드클레임_5월 = 필드클레임현황.query("일자.str.contains('2024.05.')")
곤산필드클레임_5월 = int(len(곤산필드클레임_5월['수량']))
곤산필드클레임_6월 = 필드클레임현황.query("일자.str.contains('2024.06.')")
곤산필드클레임_6월 = int(len(곤산필드클레임_6월['수량']))
곤산필드클레임_7월 = 필드클레임현황.query("일자.str.contains('2024.07.')")
곤산필드클레임_7월 = int(len(곤산필드클레임_7월['수량']))
곤산필드클레임_8월 = 필드클레임현황.query("일자.str.contains('2024.08.')")
곤산필드클레임_8월 = int(len(곤산필드클레임_8월['수량']))
곤산필드클레임_9월 = 필드클레임현황.query("일자.str.contains('2024.09.')")
곤산필드클레임_9월 = int(len(곤산필드클레임_9월['수량']))
곤산필드클레임_10월 = 필드클레임현황.query("일자.str.contains('2024.10.')")
곤산필드클레임_10월 = int(len(곤산필드클레임_10월['수량']))
곤산필드클레임_11월 = 필드클레임현황.query("일자.str.contains('2024.11.')")
곤산필드클레임_11월 = int(len(곤산필드클레임_11월['수량']))
곤산필드클레임_12월 = 필드클레임현황.query("일자.str.contains('2024.12.')")
...
################################################################################################################################
곤산필드클레임비용_1월 = 필드클레임현황.query("일자.str.contains('2024.01.')")
곤산필드클레임비용_1월 = int(곤산필드클레임비용_1월['청구금액'].sum())
곤산필드클레임비용_2월 = 필드클레임현황.query("일자.str.contains('2024.02.')")
곤산필드클레임비용_2월 = int(곤산필드클레임비용_2월['청구금액'].sum())
곤산필드클레임비용_3월 = 필드클레임현황.query("일자.str.contains('2024.03.')")
곤산필드클레임비용_3월 = int(곤산필드클레임비용_3월['청구금액'].sum())
곤산필드클레임비용_4월 = 필드클레임현황.query("일자.str.contains('2024.04.')")
곤산필드클레임비용_4월 = int(곤산필드클레임비용_4월['청구금액'].sum())
곤산필드클레임비용_5월 = 필드클레임현황.query("일자.str.contains('2024.05.')")
곤산필드클레임비용_5월 = int(곤산필드클레임비용_5월['청구금액'].sum())
곤산필드클레임비용_6월 = 필드클레임현황.query("일자.str.contains('2024.06.')")
곤산필드클레임비용_6월 = int(곤산필드클레임비용_6월['청구금액'].sum())
곤산필드클레임비용_7월 = 필드클레임현황.query("일자.str.contains('2024.07.')")
곤산필드클레임비용_7월 = int(곤산필드클레임비용_7월['청구금액'].sum())
곤산필드클레임비용_8월 = 필드클레임현황.query("일자.str.contains('2024.08.')")
곤산필드클레임비용_8월 = int(곤산필드클레임비용_8월['청구금액'].sum())
곤산필드클레임비용_9월 = 필드클레임현황.query("일자.str.contains('2024.09.')")
곤산필드클레임비용_9월 = int(곤산필드클레임비용_9월['청구금액'].sum())
곤산필드클레임비용_10월 = 필드클레임현황.query("일자.str.contains('2024.10.')")
곤산필드클레임비용_10월 = int(곤산필드클레임비용_10월['청구금액'].sum())
곤산필드클레임비용_11월 = 필드클레임현황.query("일자.str.contains('2024.11.')")
곤산필드클레임비용_11월 = int(곤산필드클레임비용_11월['청구금액'].sum())
곤산필드클레임비용_12월 = 필드클레임현황.query("일자.str.contains('2024.12.')")
...
#################################################################################################################################
conn1 = sqlite3.connect('./db/qms_kunshan.db')
곤산필드클레임 = pd.read_sql("SELECT * FROM 곤산_고객불만품질비용_2024;",conn1,index_col='index')

곤산고객불만건수_1월 = QCOST현황.query("일자.str.contains('2024.01.')")
곤산고객불만건수_1월 = int(곤산고객불만건수_1월['수량'].sum())
곤산고객불만건수_2월 = QCOST현황.query("일자.str.contains('2024.02.')")
곤산고객불만건수_2월 = int(곤산고객불만건수_2월['수량'].sum())
곤산고객불만건수_3월 = QCOST현황.query("일자.str.contains('2024.03.')")
곤산고객불만건수_3월 = int(곤산고객불만건수_3월['수량'].sum())
곤산고객불만건수_4월 = QCOST현황.query("일자.str.contains('2024.04.')")
곤산고객불만건수_4월 = int(곤산고객불만건수_4월['수량'].sum())
곤산고객불만건수_5월 = QCOST현황.query("일자.str.contains('2024.05.')")
곤산고객불만건수_5월 = int(곤산고객불만건수_5월['수량'].sum())
곤산고객불만건수_6월 = QCOST현황.query("일자.str.contains('2024.06.')")
곤산고객불만건수_6월 = int(곤산고객불만건수_6월['수량'].sum())
곤산고객불만건수_7월 = QCOST현황.query("일자.str.contains('2024.07.')")
곤산고객불만건수_7월 = int(곤산고객불만건수_7월['수량'].sum())
곤산고객불만건수_8월 = QCOST현황.query("일자.str.contains('2024.08.')")
곤산고객불만건수_8월 = int(곤산고객불만건수_8월['수량'].sum())
곤산고객불만건수_9월 = QCOST현황.query("일자.str.contains('2024.09.')")
곤산고객불만건수_9월 = int(곤산고객불만건수_9월['수량'].sum())
곤산고객불만건수_10월 = QCOST현황.query("일자.str.contains('2024.10.')")
곤산고객불만건수_10월 = int(곤산고객불만건수_10월['수량'].sum())
곤산고객불만건수_11월 = QCOST현황.query("일자.str.contains('2024.11.')")
곤산고객불만건수_11월 = int(곤산고객불만건수_11월['수량'].sum())
곤산고객불만건수_12월 = QCOST현황.query("일자.str.contains('2024.12.')")
곤산고객불만건수_12월 = int(곤산고객불만건수_12월['수량'].sum())
...
#################################################################################################################################
곤산고객불만비용_1월 = QCOST현황.query("일자.str.contains('2024.01.')")
곤산고객불만비용_1월 = int(곤산고객불만비용_1월['QCOST'].sum())
곤산고객불만비용_2월 = QCOST현황.query("일자.str.contains('2024.02.')")
곤산고객불만비용_2월 = int(곤산고객불만비용_2월['QCOST'].sum())
곤산고객불만비용_3월 = QCOST현황.query("일자.str.contains('2024.03.')")
곤산고객불만비용_3월 = int(곤산고객불만비용_3월['QCOST'].sum())
곤산고객불만비용_4월 = QCOST현황.query("일자.str.contains('2024.04.')")
곤산고객불만비용_4월 = int(곤산고객불만비용_4월['QCOST'].sum())
곤산고객불만비용_5월 = QCOST현황.query("일자.str.contains('2024.05.')")
곤산고객불만비용_5월 = int(곤산고객불만비용_5월['QCOST'].sum())
곤산고객불만비용_6월 = QCOST현황.query("일자.str.contains('2024.06.')")
곤산고객불만비용_6월 = int(곤산고객불만비용_6월['QCOST'].sum())
곤산고객불만비용_7월 = QCOST현황.query("일자.str.contains('2024.07.')")
곤산고객불만비용_7월 = int(곤산고객불만비용_7월['QCOST'].sum())
곤산고객불만비용_8월 = QCOST현황.query("일자.str.contains('2024.08.')")
곤산고객불만비용_8월 = int(곤산고객불만비용_8월['QCOST'].sum())
곤산고객불만비용_9월 = QCOST현황.query("일자.str.contains('2024.09.')")
곤산고객불만비용_9월 = int(곤산고객불만비용_9월['QCOST'].sum())
곤산고객불만비용_10월 = QCOST현황.query("일자.str.contains('2024.10.')")
곤산고객불만비용_10월 = int(곤산고객불만비용_10월['QCOST'].sum())
곤산고객불만비용_11월 = QCOST현황.query("일자.str.contains('2024.11.')")
곤산고객불만비용_11월 = int(곤산고객불만비용_11월['QCOST'].sum())
곤산고객불만비용_12월 = QCOST현황.query("일자.str.contains('2024.12.')")
...
# 고객불만품질비용 데이터 불러오기
곤산QCOST현황 = pd.read_sql("SELECT * FROM 곤산_고객불만품질비용_2024;", conn, index_col='index')

# 각 연도에 해당하는 데이터 추출
# 일자에서 연도(year) 추출
곤산QCOST현황['year'] = 곤산QCOST현황['일자'].str.slice(start=0, stop=4)
...
# 수량 합계 계산
곤산수량현황합계_2022 = int(곤산QCOST현황_2022['수량'].sum())
곤산수량현황합계_2023 = int(곤산QCOST현황_2023['수량'].sum())
곤산수량현황합계_2024 = int(곤산QCOST현황_2024['수량'].sum())
...
with tab2:
	...
	with col10:
		...
		fig10.update_layout(title_text="♍곤산 고객사 라인 부적합 월별 현황",
							title_x = 0.4,
							title_y = 0.82,
							title_xanchor = "center",
							title_yanchor = "middle")
	...
	with col11:
		...
		colors = list(range(14))
		x= ['1월','2월','3월','4월','5월','6월','7월','8월','9월','10월','11월','12월','합계']
		fig11.add_trace(go.Bar(x=x, y=곤산필드클레임비용_리스트,text = 곤산필드클레임비용_리스트,marker=dict(color=colors),opacity=1, textposition='auto',name='클레임비용',yaxis="y2"))
		...
		fig11.update_layout(title_text="♎곤산 필드 클레임 월별 현황",
							title_x = 0.4,
							title_y = 0.82,
							title_xanchor = "center",
							title_yanchor = "middle")
	...
	with col1:
		st.markdown("<h6 style='text-align: center; '>1️⃣곤산수입 검사 현황</h6>", unsafe_allow_html=True)
	...
	with col2:
		st.markdown("<h6 style='text-align: center; '>2️⃣곤산공정 검사 현황</h6>", unsafe_allow_html=True)
	...
	with col3:
		st.markdown("<h6 style='text-align: center; '>3️⃣곤산출하 검사 현황</h6>", unsafe_allow_html=True)
	...
	with col4:
		st.markdown("<h6 style='text-align: center; '>4️⃣곤산고객사 라인 불만 건수</h6>", unsafe_allow_html=True)
	...
	with col5:
		st.markdown("<h6 style='text-align: center; '>5️⃣곤산필드클레임비용(위안)</h6>", unsafe_allow_html=True)
		st.markdown("<h3 style='text-align: center; '>"+str(곤산필드클레임_합계)+'/'+str(곤산필드클레임목표금액_2024년_comma)+"</h3>", unsafe_allow_html=True) 
		option = {
		"series": [{
			"type": 'gauge',
			"startAngle": 180,
	...
	with col6:
		st.markdown("<h6 style='text-align: center; '>6️⃣곤산Q COST현황(위안)</h6>", unsafe_allow_html=True)
		st.markdown("<h3 style='text-align: center; '>"+str(곤산수량현황합계_2024)+'/'+str(곤산Q_Cost_2024년)+"</h3>", unsafe_allow_html=True) 
		option = {
		"series": [{
			"type": 'gauge',
			"startAngle": 180,
